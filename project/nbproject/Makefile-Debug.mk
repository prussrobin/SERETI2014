...
${OBJECTDIR}/Kruispunt.o: Kruispunt.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Kruispunt.o Kruispunt.c

${OBJECTDIR}/Rijbaan.o: Rijbaan.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rijbaan.o Rijbaan.c
...
${OBJECTDIR}/Stoplicht.o: Stoplicht.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stoplicht.o Stoplicht.c
